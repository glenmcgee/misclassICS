...
scenario <-  "G0_BothDec"     #"G0_Fixed" "G0_BothDec" "G0_BothInc" "G0_SensDec"
...
a0 <- 0.6; a1 <- -1 ## volume model coefficients
b0 <- -4; b1 <- 1; b2 <- 0.2 ## outcome model coefficients
...
## save
write.table(results,file=paste0(path,"results_sim",scenario,"INDUCED",suffix,".txt"),col.names=TRUE)
