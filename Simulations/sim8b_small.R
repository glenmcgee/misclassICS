...
##        Simulation 1      ##
##############################
## Updated: 05/24/2020 -- only 10% sampling fraction
## generating data:
## with random slopes (ICS and not)
## and MISCLASSIFICATION

## misclassification scenario (see manuscript)
scenario <-  "GN25_SensDec"     #"G0_Fixed" "G0_BothDec" "G0_BothInc" "G0_SensDec"
...
Vpercent <- 0.10 ## Validation sampling fraction
...
gendat <- function(nu_00=logit(0.90), ## baseline specificities
                   ...
                   VVpercent=Vpercent,## iteration number used to set seed for reproducibility
                   iter=0){
  ## set seed
